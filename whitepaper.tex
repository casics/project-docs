...
\begin{document}
\title{\vspace*{-3ex}\textls[10]{How scientists choose the software they use}:\\
...
\begin{figure}[htb]
  \centering
  \includegraphics{files/plots/how-find-ready-to-run.pdf}
  \vspace*{-2ex}
...
\section{Results: desirable data about software}
...
\begin{figure}[t]
  \centering
  \includegraphics{files/plots/info-to-include-in-index.pdf}
  \vspace*{-4ex}
