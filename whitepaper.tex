...
Comments (14) on the survey were largely positive. Many expressed the opinion that the amount of software out there made the construction of a software catalog or index a difficult task but that it would a worthwhile endeavor. A few also commented on the broader issue of searching for software, saying that "although [they] do this quite often, [they] never really considered how or why code search succeed or not". The survey "caused a bit of thinking about issues I rarely consider."
