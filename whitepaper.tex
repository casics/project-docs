...
The survey was advertised on mailing lists and social media oriented to the astronomical and biological sciences, particularly to computational subcommunities within those domains.  One of the first questions in the survey was ``What is your primary field of work?'', with multiple choices and ``Other'' as the answer options.  \fig{disciplines} shows the answer choices and the number of responses.  Of 68 respondents, 57\% identified as working in the physical sciences, 46\% in computing and maths, 28\% in biological sciences and 12\% in a range of others.  Multiple areas of work were allowed, and some respondents indicated multiple disciplines.
...
\begin{figure}[tb]
  \centering
  \small
  \begin{bchart}[min=0, max=40, step=10, width=3.7in]
    \bcbar[label=Physical Sciences,                   color=veryverylightgray, text=57\%]{39}
    \bcbar[label=Computing and Mathematical Sciences, color=veryverylightgray, text=46\%]{31}
    \bcbar[label=Biology and Biological Engineering,  color=veryverylightgray, text=28\%]{19}
    \bcbar[label=Chemical and Chemical Engineering,   color=veryverylightgray, text=3\%, value=~~2]{2}
    \bcbar[label=Geological and Planetary Sciences,   color=veryverylightgray, text=3\%, value=~~2]{2}
    \bcbar[label=Cognitive and Brain Sciences,        color=veryverylightgray, text=0]{0}
    \bcbar[label=Social Sciences,                     color=veryverylightgray, text=0]{0}
    \bcbar[label=``Aerospace Engineering (Robotics)'', color=veryverylightgray, text=1, value=~~1]{1}
  \end{bchart}
...
\begin{figure}[b]
  \centering
  \small
  \includegraphics[trim=0.75in 7.75in 1in 1.5in, scale=0.9]{files/histogram-time-spent-with-software.pdf}
  \caption{Histogram of responses to the question ``In your work, on a
...
We also asked ``In your work, on a typical day, approximately what fraction of your time involves using or interacting directly with software on a computer or other computing device?''  The answer choices took the form of a pull-down menu with values ranging from 0\% (none) to 100\% (all) in 5\% increments.  \fig{time-with-software} provides a histogram of the responses.  Assuming a typical 8 hour working day, we can conclude that 94\% regularly spent more than four hours of their time engaged with software and 68\% more than six hours.

The next question asked, ``In your work, how much freedom do you usually have to choose the software you use?''.  \fig{freedom} provide the results.  All in all,  88\% of respondents also said that they were free to make software choice decisions.


\begin{figure}[tb]
  \centering
  \small
  \begin{bchart}[min=0, max=40, step=10, width=3in]
    \bcbar[label=I never get to choose the software I use, color=veryverylightgray]{0}
    \bcbar[label=Sometimes I get to choose the software I use, color=veryverylightgray, text=6\%]{4}
    \bcbar[label=``Half the time'', color=veryverylightgray, text=6\%]{4}
    \bcbar[label={More often than not, I choose the software I use}, color=veryverylightgray, text=53\%]{36}
    \bcbar[label=I always choose the software I use, color=veryverylightgray, text=35\%]{24}
  \end{bchart}
