...
The 23 descriptions of past searches for ready-to-run software ranged from authorization management software to MCMC samplers to visualization packages. However, the actual process was similar in most cases: firstly a broad search, typically using Google, with three to four keywords 
