...
raw_data = {
    ...
    "Search in my organization's code\ncollection or repository (if any)"                              : [ 0, 12],
...
f, (ax1, ax2) = plt.subplots(1, 2, sharey=True, figsize=(5, 5.25))
