...
# plt.title('\emph{Responses to the question "What are some factors that have\n\emph{hindered your ability to FIND source code in the past?"}',
#           fontsize=10, y=1.03, x=-0.9)
