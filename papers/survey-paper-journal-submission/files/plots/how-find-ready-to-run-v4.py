...
# plt.title('\emph{Responses to the question "When you need to find ready-to-run software}\n\emph{for a particular task, how do you go about finding software?"}',
